...
export default class EventDispatcher<Payload extends IEventPayload, Name extends keyof IEventConfig = keyof IEventConfig> extends Singleton implements IEventDispatcher {
