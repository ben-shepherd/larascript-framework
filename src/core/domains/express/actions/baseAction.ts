 ...
 *
 * @param {IRouteResourceOptionsLegacy} options The options that will be passed to the action as the third argument.
 ...
 */
const baseAction = (options: IRouteResourceOptionsLegacy, action: IAction) => (req: BaseRequest, res: Response) => action(req, res, options)
