import IValidator, { ValidatorPayload } from "@src/core/domains/validator-legacy/interfaces/IValidator";
import IValidatorResult from "@src/core/domains/validator-legacy/interfaces/IValidatorResult";
import baseValidatorUtil from "@src/core/domains/validator-legacy/util/baseValidatorUtil";
 ...
 * @abstract
 */
abstract class BaseValidator<P extends ValidatorPayload = ValidatorPayload> implements IValidator {
