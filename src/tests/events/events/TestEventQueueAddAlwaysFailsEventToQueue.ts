...
import TestEventQueueAlwaysFailsEvent from "./TestEventQueueAlwaysFailsEvent";
...
class TestEventQueueAddAlwaysFailsEventToQueue extends BaseEvent {
    ...
    async execute(...args: any[]): Promise<void> {
        console.log('Executed TestEventQueueAddAlwaysFailsEventToQueue', this.getPayload(), this.getName(), {args})
